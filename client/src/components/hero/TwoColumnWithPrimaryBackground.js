...
function TwoColumnWithPrimaryBackground(props){
  const heading = "High Performant Servers tailored to your needs";
  const description = "Our cloud provisions the best servers, with fast SSD, powerful Xeon Processors, whenever you need it. Oh, and we have 99.9% SLA";
  const primaryButtonText = "Start Your 15 Day Free Trial";
  ...
  const navLinks = [
    <NavLinks key={1}>
      ...
      <NavLink onClick={ () => navigate("#")}>Pricing</NavLink>
      <NavLink onClick={ () => navigate("#")}>Login</NavLink>
      <PrimaryLink onClick={ () => navigate("#")}>Signup</PrimaryLink>
    </NavLinks>
  ];
  return (
