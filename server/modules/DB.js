...
class DatabaseConnection {
  ...
  static cleanUp = async () => {
    ...
    const pntMngr = require("./HikeRefPoints")
  ...
  static wrapperPopulate = (HikeID, file, Country, Region, Province, city, title, length, expTime, Ascent, Description, Difficulty, start, end, AssociatedGuide = 0, image) => {
    return new Promise(async (resolve, reject) => {
      ...
      let h = new hike(HikeID, title.trim(), length, Description, Ascent, Difficulty, expTime, Country, Region, Province, city, path, start, end, AssociatedGuide, image)
  ...
  static populateHuts = async () => {
    ...
    await this.wrpAddHut('1', 'Rifugio La riposa', 2185, "Mompantero, Susa", "Torino", "Piemonte", "Italy", "S", 28, 40, description, "hutImages/Rifugio-La-Riposa.jpg");
    ...
    await this.wrpAddHut('3', "Rifugio Meleze'", 1812, "Bellino", "Cuneo", "Piemonte", "Italy", "Y", 50, 40, description, 'hutImages/DSC_0171.jpeg');
    ...
    await this.wrpAddHut('20', "Rifugio I Re Magi", 1769, "Névache", "", "Provenza-Alpi-Costa Azzurra", "France", "SW", 35, 52, description, 'hutImages/banner_remagi_02.jpg');
    ...
    await this.wrpAddHut('24', "Rifugio Meira Garnieri", 1810, "Sampeyre", "Cuneo", "Piemonte", "Italy", "Y", 23, 60, description, 'hutImages/rifugio-meira-garneri.jpg');
    ...
    await this.wrpAddHut('26', "Rifugio Fontana Mura", 1726, "Coazze", "Torino", "Piemonte", "Italy", "SW", 11, 60, description, "hutImages/317924475_483027523703142_7759452976752506397_n.jpg");
    ...
    await this.wrpAddHut('28', "Rifugio Selleries", 2023, "Roure", "Torino", "Piemonte", "Italy", "Y", 70, 44, description, 'hutImages/thumbs_dsc_0047.jpg');
    ...
    await this.wrpAddHut('32', "Rifugio Jervis Cruello", 1732, "Bobbio Pellice", "Torino", "Piemonte", "Italy", "Y", 90, 50, description, 'hutImages/100_4264.jpg');
    ...
    await this.wrpAddHut('34', "Rifugio Capanna Mautino", 2110, "Cesana Torinese", "Torino", "Piemonte", "Italy", "SW", 25, 45, description, 'hutImages/il-rifugio.jpg');
    ...
    await this.wrpAddHut('45', "Salkantay Hostel - Soraypampa", 3920, "Mollepata", "", "", "Perù", "Y", undefined, 20, description, 'hutImages/default.jpg');
    ...
    await this.wrpAddHut('63', "Refugio Casa Blanca", 4789, "Milluni", "La Paz", "", "Bolivia", "Y", undefined, undefined, description, 'hutImages/default.jpg');
    ...
    description = "Hut used as foothold for the second day of ascent. You can start from here in the morning an and climb from here to the top of Huayna Potosí." +
      ...
      "No electricity.";
    await this.wrpAddHut('64', "Refugio Anselme Baud", 5272, "Milluni", "La Paz", "", "Bolivia", "Y", 40, undefined, description, 'hutImages/default.jpg');
    ...
    await this.wrpAddHut('72', "Rifugio Duca degli Abruzzi (Oriondè)", 2802, "Breuil Cervinia", "Aosta", "Valle d'Aosta", "Italy", "S", 22, 80, description, "hutImages/02_rifugio.jpg");
    ...
    await this.wrpAddHut('74', "Bivacco Gias Nuovo", 1893, "Forno Alpi Graie", "Torino", "Piemonte", "Italy", "Y", 10, 0, description, "hutImages/e5a83a7ecd853a3363498d71a1613623_L.jpg");
    ...
    await this.wrpAddHut('77', "Rifugio Alevè", 1580, "Pontechianale", "Cuneo", "Piemonte", "Italy", "Y", 50, 85, description, "hutImages/aleve.jpg");
    ...
    await this.wrpAddHut('78', "Bivacco Fratelli Berardo", 2710, "Pontechianale", "Cuneo", "Piemonte", "Italy", "Y", 9, 0, description, "hutImages/bivacco_fratelli_berardo_rita.jpg");
    ...
    await this.wrpAddHut('82', "Rifugio Casera Bosconero", 1457, "Forno di Zoldo", "Belluno", "Veneto", "Italy", "S", 24, 50, description, "hutImages/scheda-rifugio-Casera-Bosconero.jpg");
  }
